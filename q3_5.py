...
if __name__ == "__main__":
    ...
    d = 40
    sigma = 0.01
    X_filename = "X" + postfix(N, d, sigma) + ".npy"
    y_filename = "y" + postfix(N, d, sigma) + ".npy"
    X, y = load_data(X_filename, y_filename)
    ...
    plt.ylabel('RMSE')
    plt.title('RMSE vs Number of Training Samples (d=40)')
    plt.legend()
    plt.grid(True)
    plt.show()
